...
// silakan taruh code kalian di bawah
// **********************  2  ************************** 
if (empty($MK_KU1201) || empty($MK_KU1202) || empty($MK_KU1102)) {
...
// **********************  3  ************************** 
        if ($MK_KU1201 == "A") {
            $hasil = "Kimia Umum";
        }elseif ($MK_KU1202 == "AB" || $MK_KU1202 == "A" || $MK_KU1201 == "B" || $MK_KU1102 == "AB" || $MK_KU1102 == "A") {
            $hasil = "Kimia Pangan";
        }elseif ($MK_KU1202 == "AB" || $MK_KU1202 == "A" || $MK_KU1201 == "B" || $MK_KU1102 == "AB" || $MK_KU1102 == "A" || $MK_KU1201 == "A") {
            $hasil = "Kimia Pangan dan Kimia Umum";
        }else {
            $hasil = "Mohon Maaf Anda Tidak Memenuhi Persyaratan";
        }
    }
// **********************  3  ************************** 
?>
            ...
            <div class="card">
                ...
                <h3>Masukkan nilai mata kuliah anda pada form dibawah ini</h3>
                    <form action="" method="POST">
                        <div class="mb-3">
                            <label for="MK_KU1201" class="form-label">MK_KU1201</label>
                            <select class="form-select" id="MK_KU1201" name="MK_KU1201" aria-label="Default select example">
